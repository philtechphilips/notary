<section class="w-full bg-gray-50 py-28">
    ...
    <div class="flex items-center gap-6 mt-6 md:px-20 px-5">
        <div
            class="bg-[#F1F2F3] swiper-button-prev-mod-1 border border-[#C9CCCF] rounded-full h-16 w-16 flex items-center justify-center">
            <i class="ri-arrow-left-line text-3xl text-[#1D1F21]"></i>
        </div>

        <div
            class="bg-[#F1F2F3] swiper-button-next-mod-1 border border-[#C9CCCF] rounded-full  h-16 w-16 flex items-center justify-center">
            <i class="ri-arrow-right-line text-3xl text-[#1D1F21]"></i>
        </div>
    </div>
</section>
